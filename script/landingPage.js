...
var pageOptions = {
	...
	*/
	modeSelectionPage : "<img src= 'img/button_tutorial.png' onload='setAudioImg()' onclick='pageOptions.setTutorial()' id='tutorialButton'>" +
				...
				"<img src= 'img/button_time.png' onclick='pageOptions.setPage1t()' id='timeButton'>" +
				"<img src='img/button_audio_off' onclick='playBackground()' id='ayy'>" +
				"<img src='img/button_menu.png' onclick='pageOptions.setPage(),initScore();' id='menu'>",
	 ...
	 */
	tutorial1 :    "<img src='img/bg_tutorial_3_2.jpg' alt='tutorial1' width='100%' height='100%'>" +
	...
	tutorial2 :    "<img src='img/bg_tutorial_4.jpg' alt='tutorial2' width='100%' height='100%'>" +
	...
	tutorial2_1 :    "<img src='img/bg_tutorial_1.jpg' alt='tutorial2 extra' width='100%' height='100%'>" +
	...
	tutorial3 :     "<img src='img/bg_tutorial_2.jpg' alt='tutorial3' width='100%' height='100%'>" +
    ...
    tutorial3_1 :     "<img src='img/bg_tutorial_2_1.jpg' alt='tutorial3 extra' width='100%' height='100%'>" +
    ...
    tutorial3_2 :     "<img src='img/bg_tutorial_3.jpg' alt='tutorial3 extra' width='100%' height='100%'>" +
	...
	tutorial3_3 :     "<img src='img/bg_tutorial_3_1.jpg' alt='tutorial3 extra' width='100%' height='100%'>" +
	...
	tutorial4 :    "<img src='img/bg_tutorial_5.jpg' alt='tutorial4' width='100%' height='100%'>" +
	...
	setLevelUnlock : function(){
		...
		this.levelPage +=
	"<img src='' onclick='playBackground()' id='ayy'>" +
	"<img src='img/button_menu.png' onclick='pageOptions.setPage(),initScore();' id='menu'>"; //location.reload()
	},
...
/**
	...
	*/
    ...
    "<h3 id='grid3' style='font-size:22px;color:white;position:absolute;left:10px;margin-top:15px;'></h3>"+
        ...
        "<img src='img/button_menu.png' onclick='pageOptions.setPage(),initScore();,initScore();' id='menu'>" +
